...
| SEO / sitemap / structured data | Storefront Frontend Dev | — |
...
| Activity | PM | Tech Lead | Brand | Backend | Admin FE | Store FE | QA | DevOps |
|----------|----|-----------|-------|---------|----------|----------|----|--------|
| Feature spec | **R** | C | — | I | I | I | I | — |
| DB schema design | I | **A** | — | R | I | — | C | — |
| API contract design | I | **A** | — | R | C | C | C | — |
| Brand identity | I | I | **R** | — | — | C | — | — |
| Admin UI implementation | — | C | — | — | **R** | — | A | — |
| Storefront implementation | — | C | C | — | — | **R** | A | — |
| Backend implementation | I | C | — | **R** | — | — | A | — |
| Testing & QA | I | I | — | C | C | C | **R** | — |
| Deployment | I | C | — | I | I | I | C | **R** |
| Monitoring | I | C | — | I | — | — | C | **R** |
